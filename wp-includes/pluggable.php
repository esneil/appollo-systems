 ...
 * in the database and in the wp-config-back.php file. The secret key in the database
 * is randomly generated and will be appended to the secret keys in wp-config-back.php.
 *
 * The secret keys in wp-config-back.php should be updated to strong, random keys to maximize
 * security. Below is an example of how the secret key constants are defined.
 * Do not paste this example directly into wp-config-back.php. Instead, have a
 ...
 * @since 2.5.0
 *
 * @link https://api.wordpress.org/secret-key/1.1/salt/ Create secrets for wp-config-back.php
 *
