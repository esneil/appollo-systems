...
function network_step2( $errors = false ) {
	...
	if ( ! file_exists( ABSPATH . 'wp-config-back.php' ) && file_exists( dirname( ABSPATH ) . '/wp-config-back.php' ) ) {
...
?>
		...
		<div class="updated inline"><p><?php
			if ( file_exists( $home_path . '.htaccess' ) ) {
				...
				printf(
					/* translators: 1: wp-config-back.php 2: .htaccess */
				...
				echo '<strong>' . __( 'Caution:' ) . '</strong> ';
				printf(
					/* translators: 1: wp-config-back.php 2: web.config */
					__( 'We recommend you back up your existing %1$s and %2$s files.' ),
					'<code>wp-config-back.php</code>',
				...
				echo '<strong>' . __( 'Caution:' ) . '</strong> ';
				printf(
					/* translators: 1: wp-config-back.php */
...
?>
		<ol>
			<li><p><?php printf(
				/* translators: 1: wp-config-back.php 2: location of wp-config file, 3: translated version of "That's all, stop editing! Happy blogging." */
